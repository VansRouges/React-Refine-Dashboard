...
export const authProvider: AuthProvider = {
  ...
  getIdentity: async () => {
    ...
    try {
        ...
        // we're using me:any because the GraphQL API doesn't have a typr for the me query yet.
        // we'll add some qqueries and mutations later and change this to User which will be generated by codegen.
